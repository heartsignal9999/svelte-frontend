...
<img src="/img/blog/2/2_0.png" alt="Summary of the Project"  class="rounded  p-4">	
...
<h2 class="font-bold text-xl text-gray-700">모델 훈련 데이터셋 소개: 서코 디지스코프 데이터셋</h2>
<p class='text leading-relaxed text-gray-600 text-justify'>이제 심장음으로부터 심장 박동을 포착하는 모델을 만들기 위해 사용한 데이터를 살펴보겠습니다(Exploratory Data Analysis, 데이터의 탐색적 분석). 과제를 제안한 스마트사운드는 여러 사업과 정부 과제를 수행하면서 자체적으로 심장음을 수집해오고 있습니다. 하지만 의료법과 개인정보 보호법 위반 소지가 있어 기업 측으로부터 데이터를 제공받을 수는 없습니다. 
...
<p class='text leading-relaxed text-gray-600 text-justify'>데이터셋은 wav, hea, tsv, txt 모두 네 가지 종류의 확장자 파일로 구성되어 있습니다. 각 파일별 특성을 자세히 살펴보겠습니다. 
...
<p class='text leading-relaxed text-gray-600 text-justify'>피지오넷 2016 챌린지는 심음의 정상/비정상 여부, 2022 챌린지는 심잡음 여부를 판별하기 위해 이 데이터셋을 사용했습니다. 하트시그널 프로젝트는 심장 질환 전조 증상을 포착하기 위한 이 두 챌린지와는 다른, 심장박동 자체를 포착하기 위한 과업을 수행했습니다.
