...
export const title: string = "심장음 세그멘테이션 모델 개발기 (Establishing Measurement Model for Heart Sound Using Segmentation)";
...
<p class='text-lg leading-relaxed'>참고자료</p>
  ...
  <p><sup id="footnote-2">2 </sup>위키백과 한국어판 웹사이트, <a href="https://ko.wikipedia.org/wiki/%EC%8B%AC%EB%B0%95%EC%88%98" target="_blank" class="text-blue-500 hover:text-blue-700">심박수</a> 항목<a href="#ref-2">↩</a>
